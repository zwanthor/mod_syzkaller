...
func CalculatePriorities(corpus []*Prog, weighted []string, inc_weight float32) [][]float32 {
	static := calcStaticPriorities(weighted, inc_weight)
...
func calcStaticPriorities(weighted []string, inc_weight float32) [][]float32 {
